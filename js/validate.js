...
//hookup the form submit button to validate function
$(document).ready(function(){
   $('input[type="submit"]').on("click",validate);//when user clicks the submit button run the validate function 
});                     
...
function validate(event)
{
    ...
    //keep track of whether or not form has any errors
    var isError = false;
    ...
    //validate that the hours are numeric and between 1-100
